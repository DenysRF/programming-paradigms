...
import block4.cc.iloc.model.Instr;
import block4.cc.iloc.model.Label;
import block4.cc.iloc.model.Num;
import block4.cc.iloc.model.Op;
import block4.cc.iloc.model.OpCode;
import block4.cc.iloc.model.OpList;
import block4.cc.iloc.model.Operand;
import block4.cc.iloc.model.Operand.Type;
import block4.cc.iloc.model.Program;
import block4.cc.iloc.model.Reg;
import block4.cc.iloc.model.Str;
import block4.cc.iloc.parse.ErrorListener;
import block4.cc.iloc.parse.FormatException;
import block4.cc.iloc.parse.ILOCBaseListener;
import block4.cc.iloc.parse.ILOCLexer;
import block4.cc.iloc.parse.ILOCParser;
import block4.cc.iloc.parse.ILOCParser.CommentContext;
import block4.cc.iloc.parse.ILOCParser.DeclContext;
import block4.cc.iloc.parse.ILOCParser.InstrContext;
import block4.cc.iloc.parse.ILOCParser.InstrListContext;
import block4.cc.iloc.parse.ILOCParser.OpCodeContext;
import block4.cc.iloc.parse.ILOCParser.OperandContext;
import block4.cc.iloc.parse.ILOCParser.ProgramContext;
import block4.cc.iloc.parse.ILOCParser.RealOpContext;
import block4.cc.iloc.parse.ILOCParser.SingleInstrContext;
import block4.cc.iloc.parse.ILOCParser.SourcesContext;
import block4.cc.iloc.parse.ILOCParser.TargetsContext;
